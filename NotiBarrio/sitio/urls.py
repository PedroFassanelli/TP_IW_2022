...
urlpatterns = [
    ...
    #path('nuevocomentario/<int:id_publicacion><int:id_user>', views.nuevoComentario, name='nuevocomentario'),
    path('nuevocomentario/<int:id_publicacion>', views.nuevoComentario, name='nuevocomentario'),
